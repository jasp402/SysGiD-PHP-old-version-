app.service('public', function () 
  {
    ...
    .service('ClearForm',function ($rootScope) {
      this.easyFrom = function (fdata) {
        $rootScope.fdata = fdata;
        angular.forEach($rootScope.fdata, function (value, key) {
          return $rootScope.fdata[key]='';
        });
      }
    })
    ...
    .service('AlertGlobal', function (sweet){
      this.bienvenida = function(t,m){
        sweet.show({
          title:  "<small>Cargando:</small> <br> "+t+"<div class='progress'><div class='progress-bar progress-bar-primary progress-bar-striped active' role='progressbar' aria-valuenow='0' aria-valuemin='0' aria-valuemax='100' style='width: 100%'></div></div>",
          text:   m,
          html: true,
